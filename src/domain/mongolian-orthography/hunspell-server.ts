...
// Use explicit UTF-8 strings because nspell's constructor accepts string/Buffer,
// while dictionary-mn exposes its data as Uint8Array values.
const aff = Buffer.from(mn.aff);
const dic = Buffer.from(mn.dic);
