...
const LEGAL_PROBLEMS: readonly StudentLegalProblem[] = [
  {
    ...
    title: "Эрүүгийн эрх зүй — кейс шинжилгээ",
    intro:
      "Доорх баримтыг Эрүүгийн хуулийн 2.1 дугаар зүйлд заасан гэмт хэргийн ойлголтоос эхэлж, бүрэлдэхүүн (объект, объектив тал, субъект, субъектив тал) → хууль бус байдал → буруутай байдал, шаардлагатай бол хамтран оролцоо, гэмт хэргийг үгүйсгэх нөхцөл байдлыг нэмж → дүгнэлт гэсэн дарааллаар бичгээр бүрэн задал. Зохиомол зүйл, заалт бүү ашигла.",
    factPattern:
    ...
    prompt:
      "А-ийн үйлдэлд ямар бүрэлдэхүүн (объект, объектив тал, субъект, субъектив тал) тогтоогдож болохыг, хууль бус байдал (гэмт хэргийг үгүйсгэх нөхцөл байдал байгаа эсэхийг оролцуулан), буруутай байдлыг баримтад тулгуурлан бичгээр бүрэн шинжлээд, эцэст нь дүгнэлт гарга.",
  ...
  },
  {
    ...
    title: "Иргэний эрх зүй — кейс шинжилгээ",
    intro:
      "Доорх баримтыг шаардлага үүссэн эсэх → дуусгавар болсон уу → хэрэгжүүлэх боломжтой юу → дүгнэлт гэсэн дарааллаар бичгээр бүрэн задал.",
    factPattern:
  ...
  },
  {
    ...
    title: "Захиргааны эрх зүй — кейс шинжилгээ",
    intro:
      "Доорх баримтыг Монголын гурван үеийн (урьдчилсан нөхцөл → хууль ёсны байдал → үр дагавар) аргачлалаар бичгээр бүрэн задал.",
    factPattern:
