...
export const en: Dictionary = {
  ...
  publicHome: {
    ...
    chatSubtitle: "Describe the issue in your own words.",
    ...
    products: {
      ...
      legalAi: {
        name: "TORE Legal AI",
        audience: "Lawyer",
        description: "Professional legal work environment.",
        cta: "Open workspace",
      },
    },
    intelligenceTitle: "Overview",
    intelligenceLead: "Legal information — from sources we already have.",
    intelligenceEmpty: "No items yet.",
    intelligenceSections: {
      enactedLaws: "Newly enacted laws",
      draftBills: "Draft bills",
      discussion: "Discussion stage",
